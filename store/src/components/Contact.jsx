    ...
    <div className=" bg-boxwind2">
      <div className="grid lg:grid-cols-2 ">
        <div className="relative">
          ...
          <p className=" absolute hidden lg:block font-extrabold top-[99px] text-6xl right-0">
            SHOP
          </p>
        </div>

        <div className="text-black flex flex-col my-4 lg:pt-[75px] lg-py-0  py-5 ">
          <p className="lg:text-6xl px-2 lg:block hidden font-extrabold">
            THIS LOOK
          </p>
          <p className="lg:text-6xl px-2 text-4xl tracking-wide lg:hidden font-bold ">
            SHOP THIS LOOK
          </p>
        ...
        <img
          className="lg:h-[470px] lg:order-last lg:w-[900px]"
          src="pics/girldrk2.jpg"
        />
        <div className=" lg:px-[100px] lg:pt-6 m-3  text-black">
          <div className=" border-boxwind border-2 p-4 py-5">
            ...
            <p className=" text-gray">
              ...
              auctor. Maecenas faucibus mollis interdum
            </p>
            <div className="flex my-2">
              <input
                placeholder="Email"
                className="bg-boxwind rounded-[4px] px-2 w-[100%] "
              />
